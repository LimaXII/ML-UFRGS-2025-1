...
print(df[['departure_time_num', 'arrival_time_num', 'route_combined', 'stops_numeric']].head())
...
print(df[df['duration'] <= 0][['source_city', 'destination_city', 'duration']])

# Verificar preços zero ou negativos
print("\nVoos com preço zero ou negativo:")
print(df[df['price'] <= 0][['airline', 'source_city', 'destination_city', 'price']])
